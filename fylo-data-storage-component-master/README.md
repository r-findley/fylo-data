...
- [x] Update the README to reflect my personal challenge goals
- [x] Initialize as a git repository on github
- [] Create an index.html file that reflects the appropriate layout
- [] Create a CSS file that includes responsive design
- [x] Deploy the project via Vercel
- [] Share the solution to Frontend Mentor and Slack
